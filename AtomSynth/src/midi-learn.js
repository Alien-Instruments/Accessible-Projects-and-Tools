...
const ACTIVE_PRESET_KEY = "atomSynth_midiCCMappings";
const PRESET_COLLECTION_KEY = "ATOMSYNTH_MIDI_CC_PRESETS";
...
function handleMIDIMessage(event) {
  ...
  if (isCC) {
    if (learning && currentTarget) {
      ...
      currentTarget.closest(".mod-row")?.classList.remove("learning");
...
// --- MAPPING CONTROLS ---
export function enableMIDILearnMode(containerId = "synth") {
  ...
  controls.forEach((el) => {
    el.addEventListener("contextmenu", (e) => {
      ...
      learning = true;
      currentTarget = el;
      el.closest(".mod-row")?.classList.add("learning");
